...
export type InstallerManufacturerAuthDrift = {
  authUserId: string;
  email: string;
  displayName: string;
  role: "installer" | "manufacturer" | "scheduler";
};

/**
 * Auth users whose profile says installer/manufacturer/scheduler but who are not linked from
