...
export default async function ManagementInstalledPhotoPage({
  params,
}: {
  ...
  return <InstalledPhotoForm mediaItems={mediaItems} milestones={milestones} routeBasePath="/management/units" />;
}
