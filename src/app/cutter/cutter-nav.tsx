...
import { ChartBar, CheckCircle, Factory, Queue, Scissors } from "@phosphor-icons/react";

const navItems = [
  { href: "/cutter", label: "Dashboard", Icon: ChartBar },
  { href: "/cutter/queue", label: "Queue", Icon: Queue },
  { href: "/cutter/production", label: "Production", Icon: Scissors },
  { href: "/cutter/process", label: "Process", Icon: Factory },
