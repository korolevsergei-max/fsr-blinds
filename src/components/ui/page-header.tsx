      ...
      <div className="flex items-center gap-3 px-4 py-3">
        {backHref && (
          <button
            ...
            className="flex items-center justify-center w-9 h-9 -ml-1 rounded-xl text-muted hover:text-foreground hover:bg-zinc-100 transition-colors active:scale-[0.96]"
          >
