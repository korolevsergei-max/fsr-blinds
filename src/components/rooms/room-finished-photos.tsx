      ...
      >
        ...
        {open && (
          <>
            ...
            />
            <div
              className="animate-fade-scale fixed inset-x-4 top-1/2 z-[60] flex flex-col -translate-y-1/2 rounded-3xl border border-border bg-white shadow-2xl max-w-lg mx-auto"
            >
              {/* Header */}
